 ...
 */
public class MainMenuScreen extends com.github.autoreceipter.screens.BaseScreen {
    ...
    public MainMenuScreen(final AutoReceipter app) {
        ...
        listButton.addListener(new ClickListener() {
            @Override
            public void clicked(InputEvent event, float x, float y) {
                app.switchScreens(new com.github.autoreceipter.screens.ListScreen(app));
        ...
        questionMarkButton.addListener(new ClickListener() {
            @Override
            public void clicked(InputEvent event, float x, float y) {
                app.switchScreens(new com.github.autoreceipter.screens.HelpScreen(app));
    ...
    @Override
    public transitionDir getDirection(com.github.autoreceipter.screens.BaseScreen nextScreen) {

        if(nextScreen.getClass() == com.github.autoreceipter.screens.HelpScreen.class)
